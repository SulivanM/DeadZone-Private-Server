package starling.utils
{
   ...
   public class MatrixUtil
   {
      ...
      {
         var _loc4_:Number = param1.a;
         var _loc5_:Number = param1.b;
         var _loc6_:Number = param1.c;
         var _loc7_:Number = param1.d;
         var _loc8_:Number = param1.tx;
         var _loc9_:Number = param1.ty;
         var _loc10_:Number = Math.sin(param2);
         var _loc11_:Number = Math.cos(param2);
         var _loc12_:Number = Math.sin(param3);
         var _loc13_:Number = Math.cos(param3);
         param1.a = _loc4_ * _loc13_ + _loc6_ * _loc12_;
         param1.b = _loc5_ * _loc13_ + _loc7_ * _loc12_;
         param1.c = _loc6_ * _loc11_ - _loc4_ * _loc10_;
         param1.d = _loc7_ * _loc11_ - _loc5_ * _loc10_;
      }
