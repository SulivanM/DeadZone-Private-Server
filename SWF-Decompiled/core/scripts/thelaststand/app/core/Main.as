package thelaststand.app.core
{
   ...
   public class Main extends Sprite
   {
      ...
      {
         var startHandler:Function = function():void
         {
      ...
      private function onNetworkGameReady() : void
      {
         ...
         TweenMax.killTweensOf(this.mc_loadProgress);
         this.mc_titleScreen.message = this._lang.getString("load_survivors");
         this.mc_titleScreen.details = "";
         this.mc_loadProgress.progress = 0;
      ...
      private function onNetworkGameDataReceieved() : void
      {
         ...
         for each(_loc4_ in _loc3_.res)
         {
            _loc2_.push(_loc4_.toString());
         }
         for each(_loc5_ in this._resources.getResource("xml/buildings.xml").content..snd.children())
         {
      ...
      private function onReady() : void
      {
         ...
         {
            var dlg:CreateSurvivorDialogue = null;
            mc_titleScreen = null;
