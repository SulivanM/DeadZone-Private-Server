package thelaststand.app.game.logic
{
   ...
   public class PlayerCompoundDirector implements ISceneDirector
   {
      ...
      public function createBuilding(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this._network.playerData.canBuildBuilding(id,0,buy))
         {
            return;
         }
         bld = new Building(this._resources.getResource("xml/buildings.xml").content.item.(@id == id)[0]);
      ...
      private function onTimerStarted(param1:TimerData) : void
      {
         ...
         var _loc3_:BatchRecycleJob = param1.target as BatchRecycleJob;
         if(_loc3_ != null)
         {
            try
            {
      ...
      private function onTimerCompleted(param1:TimerData) : void
      {
         ...
         var _loc4_:MissionData = param1.target as MissionData;
         if(_loc4_ != null)
         {
         ...
         var _loc5_:BatchRecycleJob = param1.target as BatchRecycleJob;
         if(_loc5_ != null)
         {
            try
            {
