   ...
   public class Survivor extends AISurvivorAgent implements ISerializable
   {
      ...
      override public function applyDamageResistance(param1:Number, param2:uint) : Number
      {
         ...
         if(this._activeLoadout != null)
         {
            ...
            {
               _loc4_ = 0;
               _loc4_ = _loc4_ + this._activeLoadout.getLoadoutAttributeMod(ItemAttributes.GROUP_SURVIVOR,_loc3_);
               _loc4_ = _loc4_ + Network.getInstance().playerData.compound.effects.attributes.getModValue(ItemAttributes.GROUP_SURVIVOR,_loc3_);
