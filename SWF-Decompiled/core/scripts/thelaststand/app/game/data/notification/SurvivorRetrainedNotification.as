package thelaststand.app.game.data.notification
{
   ...
   public class SurvivorRetrainedNotification implements INotification
   {
      ...
      public function SurvivorRetrainedNotification(param1:String)
      {
         super();
      ...
      public function open() : void
      {
         ...
         dlg = new MessageBox(lang.getString("srv_retrain_msg",this._data.fullName));
         dlg.addTitle(lang.getString("srv_retrain_title",this._data.fullName),4671303);
         dlg.addButton(lang.getString("srv_retrain_ok"));
      ...
      {
         return NotificationType.SURVIVOR_REASSIGNED;
      }
