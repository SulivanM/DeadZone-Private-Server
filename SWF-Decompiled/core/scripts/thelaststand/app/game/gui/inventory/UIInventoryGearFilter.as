package thelaststand.app.game.gui.inventory
{
   ...
   import thelaststand.app.game.data.itemfilters.GearFilterData;
   ...
   public class UIInventoryGearFilter extends UIInventoryFilter
   {
      ...
      public function UIInventoryGearFilter()
      {
         ...
         this.input_levelMin.enterPressed.add(this.onInputLevelMaxEnterPressed);
         ...
         this.btn_sortAlpha.width = this.btn_sortAlpha.height = height;
         ...
         this.btn_sortLevel.width = this.btn_sortLevel.height = this.btn_sortAlpha.width;
      ...
      override protected function draw() : void
      {
         ...
         this.btn_sortAlpha.x = int(_width - this.btn_sortAlpha.width - 2);
         this.btn_sortAlpha.y = int((height - this.btn_sortAlpha.height) * 0.5);
         this.btn_sortLevel.x = int(this.btn_sortAlpha.x - this.btn_sortLevel.width - 8);
         this.btn_sortLevel.y = int(this.btn_sortAlpha.y);
      }
      
      private function setToCurrentFilterValues() : void
      {
         var _loc1_:GearFilterData = GearFilterData(_filterData);
      ...
      private function onClickSortOption(param1:MouseEvent) : void
      {
         ...
         var _loc3_:GearFilterData = GearFilterData(_filterData);
