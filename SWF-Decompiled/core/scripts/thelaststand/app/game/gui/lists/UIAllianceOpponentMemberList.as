package thelaststand.app.game.gui.lists
{
   ...
   public class UIAllianceOpponentMemberList extends UIPagedList
   {
      ...
      public function UIAllianceOpponentMemberList()
      {
         ...
         _itemSpacingY = 1;
         listItemClass = UIAllianceOpponentMemberListItem;
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:UIAllianceOpponentMemberListItem = null;
         ...
         while(_loc1_ < _loc5_)
         {
            _loc2_ = new UIAllianceOpponentMemberListItem();
      ...
      override protected function positionItems() : void
      {
         ...
         var _loc12_:UIAllianceOpponentMemberListItem = null;
         _loc3_ = _paddingX;
         _loc4_ = _paddingY;
         this._pageHeight;
         _loc1_ = 0;
         ...
         while(_loc1_ < _loc2_)
         {
            _loc12_ = _items[_loc1_] as UIAllianceOpponentMemberListItem;
            _loc12_.x = _loc3_;
            _loc12_.y = _loc4_;
      ...
      private function itemSort(param1:UIAllianceOpponentMemberListItem, param2:UIAllianceOpponentMemberListItem) : int
      {
      ...
      private function getItemByMemberId(param1:String) : UIAllianceOpponentMemberListItem
      {
         var _loc3_:UIAllianceOpponentMemberListItem = null;
         var _loc2_:int = 0;
         while(_loc2_ < _items.length)
         {
            _loc3_ = UIAllianceOpponentMemberListItem(_items[_loc2_]);
