package thelaststand.app.game.gui.raid
{
   ...
   public class RaidRewardsView extends UIComponent
   {
      ...
      public function RaidRewardsView()
      {
         super();
         ...
         this.txt_desc.htmlText = Language.getInstance().getString("raid.rewards_msg");
         ...
         this.txt_rollover.text = Language.getInstance().getString("raid.rewards_rollover");
      ...
      public function setData(param1:RaidData) : void
      {
         ...
         this.ui_progress.setData(this._raidData.xml.rewards.tier);
         invalidate();
      }
      ...
      override protected function draw() : void
      {
         ...
         this.txt_title.text = Language.getInstance().getString("raid.rewards_title",Language.getInstance().getString("raid." + this._raidData.name + ".name")).toUpperCase();
         this.txt_title.x = 10;
         ...
         this.txt_pts.width = int(this.txt_ptsTitle.x - (this.bmp_ptsIcon.x + this.bmp_ptsIcon.width) - 8);
         this.txt_pts.x = int(this.bmp_ptsIcon.x + this.bmp_ptsIcon.width + 4);
         this.txt_pts.y = int(_loc3_ + (_loc2_ - this.txt_pts.height) * 0.5 - 4);
         ...
         this.ui_progress.fadedValue = this._raidData.points;
         this.ui_progress.solidValue = this._raidData.currentRewardTier > -1 ? int(this._raidData.xml.rewards.tier[this._raidData.currentRewardTier].@score) : 0;
