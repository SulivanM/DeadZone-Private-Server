package thelaststand.app.game.gui.raid
{
   ...
   public class RaidSurvivorsView extends UIComponent
   {
      ...
      public function RaidSurvivorsView()
      {
         super();
      ...
      public function setData(param1:RaidData) : void
      {
         ...
         _loc4_ = 0;
         while(_loc4_ < this._raidData.maxSurvivorCount)
         {
            _loc5_ = new UIMissionSurvivorSlot(UIMissionSurvivorSlot.SHOW_HEAL,_loc3_,46,UISurvivorPortrait.SIZE_32x32);
            _loc5_.mouseEnabled = _loc5_.mouseChildren = !this._raidData.hasStarted;
      ...
      override protected function draw() : void
      {
         ...
         this.txt_title.text = Language.getInstance().getString("raid.survivors").toUpperCase();
      ...
      private function updateSurvivors() : void
      {
         ...
         while(_loc1_ < this._slots.length)
         {
            ...
            _loc3_ = _loc1_ < this._raidData.survivorIds.length ? this._raidData.survivorIds[_loc1_] : null;
