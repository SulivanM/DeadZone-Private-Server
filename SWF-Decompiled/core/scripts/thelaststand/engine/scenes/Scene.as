package thelaststand.engine.scenes
{
   ...
   public class Scene
   {
      ...
      public function populateFromDescriptor(param1:XML, param2:Number = NaN, param3:Boolean = true) : void
      {
         var _loc4_:XML = null;
      ...
      protected function populateRandomizedElements(param1:Number = 0) : void
      {
         ...
         for each(_loc9_ in _loc8_)
         {
            ...
            {
               Cc.warn("Resource not found: " + _loc16_);
            }
            else
            {
