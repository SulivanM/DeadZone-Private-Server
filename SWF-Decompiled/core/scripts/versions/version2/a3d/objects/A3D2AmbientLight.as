package versions.version2.a3d.objects
{
   ...
   public class A3D2AmbientLight
   {
      ...
      public function A3D2AmbientLight(param1:int, param2:uint, param3:Long, param4:Number, param5:String, param6:Long, param7:A3D2Transform, param8:Boolean)
      {
         super();
      ...
      {
         var _loc1_:String = "A3D2AmbientLight [";
