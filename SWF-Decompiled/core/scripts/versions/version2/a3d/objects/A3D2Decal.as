package versions.version2.a3d.objects
{
   ...
   public class A3D2Decal
   {
      ...
      public function A3D2Decal(param1:int, param2:Long, param3:int, param4:String, param5:Number, param6:Long, param7:Vector.<A3D2Surface>, param8:A3D2Transform, param9:Vector.<int>, param10:Boolean)
      {
         super();
         ...
         this._surfaces = param7;
         this._transform = param8;
         this._vertexBuffers = param9;
